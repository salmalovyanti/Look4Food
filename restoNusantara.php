...
<head>
    ...
    <title>Resto Nusantara | Look4Food</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="box" id="pic-1">
        <div class="rest-header">
            <img src="img/rest1_1.avif" alt="">
        </div>
        <div class="rest-header">
            <img src="img/rest1_2.jpg" alt="">
        </div>
        <div class="rest-header">
            <img src="img/rest1_3.avif" alt="">
        </div>
    ...
    <div class="box">
        <div class="sec-30">
            ...
            <div class="box">
                ...
                <p class="serv-time">10.00 - 22.30</p>              
            </div>
            <p class="serv">Dine In & Take Away</p> 
            <p class="inrate">4.8 Ratings</p> 
        </div>
        <div class="sec-70">
            <p class="desc">Serving a variety of traditional Indonesian dishes with authentic flavors.</p>
            <p class="rec">Jagakarsa, South Jakarta</p>
        </div>        
    </div>
    ...
    <div class="menu-box">
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            <div class="col">
              <div class="card">
                <img src="img/nasigoreng.avif" class="card-img-top">
                <div class="card-body">
            ...
            <div class="col">
              <div class="card">
                <img src="img/chickensatay.avif" class="card-img-top">
                <div class="card-body">
            ...
            <div class="col">
              <div class="card">
                <img src="img/rendang.jpg" class="card-img-top">
                <div class="card-body">
    ...
    <div id="review" class="hidden">
        ...
        <!-- Add Review -->
        <form action="restoNusantara_add.php"  method="post">
            <div class="rev-box">
                <div class="rev-sq">
                    <div class="add-rev">
